...
if ($Id) :
    ...
    if ($Read->getResult()) :
        ...
        header('Location: dashboard.php?wc=procedimentos/home&user=' . $UserId);
        exit;
    endif;
else :
    $NewFormulario = [
    ...
    header('Location: dashboard.php?wc=procedimentos/create&id=' . $Create->getResult() . '&user=' . $UserId);
endif;
?>
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="dashboard.php?wc=procedimentos/home&ana=<?= $UserId ?>" class="text-muted">Procedimentos</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="card card-custom">
                <div class="card-header py-3">
                    ...
                    <div class="card-toolbar">
                        <span rel='dashboard_header_search' callback='Procedimentos' callback_action='delete' class='btn btn-danger j_swal_action' id='<?= $Id; ?>'>Deletar Registro!</span>
                    </div>
                </div>
                <form class="auto_save j_tab_home tab_create" name="user_manager" action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="callback" value="Procedimentos" />
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                ...
                                <select name="change_pront_id" id="" class="form-control">
                                    <option value="" disabled>Selecione um Prontuário</option>
                                    <?php
