...
$ProId = filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT);
if ($ProId) :
    $Read->ExeRead(DB_USERS, "WHERE user_id = :id", "id={$ProId}");
    if ($Read->getResult()) :
            ...
            <div class="card card-custom">
                <div class="card-header py-3">
                    ...
                    <div class="card-toolbar">
                        <span rel='dashboard_header_search' callback='Clientes' callback_action='delete' class='btn btn-danger j_swal_action' id='<?= $ProId; ?>'>Deletar Registro!</span>
                    </div>
                </div>
                <form class="auto_save j_tab_home tab_create" name="user_manager" action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="user_id" value="<?= $ProId; ?>" />
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <label>CRM:</label>
                                <input class="form-control" value="<?= $user_crm; ?>" type="text" name="user_crm" id="user_crm" placeholder="CRM" />
                            </div>
                        </div>
