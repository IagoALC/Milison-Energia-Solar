        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="dashboard.php?wc=modelo/home" class="text-muted">Clientes</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-label">Listagem de Clientes
                    <span class="d-block text-muted pt-2 font-size-sm"></span>
                </h3>
            </div>
            <div class="card-toolbar">
                <a href="dashboard.php?wc=modelo/create" class="btn btn-primary font-weight-bolder">
            ...
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                ...
                <tbody>
                    ...
                    foreach ($Read->getResult() as $Users) :
                        extract($Users);
                        $Read->ExeRead(DB_USERS_ADDR, "WHERE user_id={$user_id}", "");
                        if (!$Read->getResult()) :
                            $NewAddres = ['user_id' => $user_id, 'addr_name' => 'Novo Endereço'];
                    ...
                    ?>
                        <tr role="row">
                            ...
                            <td style="text-align: left" class="formCpf"><?= $user_document ?></td>
                            <td style="text-align: left"><?= $user_telephone ?></td>
                            <td style="text-align: left"><?= $user_email ?></td>
                            <td style="text-align: left"><?= $addr_district ?></td>
                            <td nowrap="nowrap">
                                <a href="dashboard.php?wc=modelo/create&id=<?= $user_id ?>" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
                                    <span class="svg-icon svg-icon-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
