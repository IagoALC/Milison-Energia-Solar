                ...
                <form class="auto_save j_tab_home tab_create" name="user_manager" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <label>Título:</label>
                                <input class="form-control" value="<?= $formulario_title; ?>" type="text" name="formulario_title" placeholder="Título" />
                            </div>

                            <div class="col-lg-6">
                                <label>Status:</label>
                                <select name="formulario_status" class="form-control">
                                    <option value="1" <?= $formulario_status == 1 ? "selected" : "" ?>>Aberto</option>
                                    <option value="0" <?= $formulario_status == 0 ? "selected" : "" ?>>Fechado</option>
                                </select>
                            </div>
