    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-label">Listagem de Intros
        ...
        <div class="card-body">
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                ...
                <tbody>
                    <?php
                    $Read->ExeRead(DB_INTRO);
                    if ($Read->getResult()) :
                        foreach ($Read->getResult() as $Intro) :
                            extract($Intro);
                    ?>
                            <tr role="row">
                                <td style="text-align: left"><?= $intro_title ?></td>
                                <td style="text-align: left"><?= $intro_desc ?></td>
                                <td nowrap="nowrap">
                                    <a href="dashboard.php?wc=site/intro/create&id=<?= $intro_id ?>" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
