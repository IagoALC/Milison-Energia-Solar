    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            ...
            <div class="card-toolbar">
                <a href="dashboard.php?wc=site/step/create" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                ...
                <tbody>
                    <?php
                    $Read->ExeRead(DB_STEP);
                    if ($Read->getResult()) :
                        foreach ($Read->getResult() as $Step) :
                            extract($Step);
                    ?>
                            <tr role="row">
                                <td style="text-align: left"><?= $step_title ?></td>
                                <td style="text-align: left"><?= $step_desc ?></td>
                                <td nowrap="nowrap">
                                    <a href="dashboard.php?wc=site/step/create&id=<?= $step_id ?>" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
                                        <span class="svg-icon svg-icon-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24" />
