...
if ($FaqId) :
    ...
    if ($Read->getResult()) :
        ...
        header('Location: dashboard.php?wc=site/faq_home');
        exit;
    endif;
else :
    $NewFaq = ["faq_title" => ""];
    $Create->ExeCreate(DB_FAQS, $NewFaq);
    header('Location: dashboard.php?wc=site/faq_create&id=' . $Create->getResult());
    exit;
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="dashboard.php?wc=site/faq_home" class="text-muted">Faqs</a>
                    </li>
                </ul>
            </div>
        </div>
