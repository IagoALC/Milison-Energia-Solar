...
if ($PostData && $PostData['callback_action'] && $PostData['callback'] == $CallBack) :
    ...
    switch ($Case):
        case 'manager':
            ...
            if($PostData['user_level'] != 5):
                $PostData['user_comissao'] = str_replace(",", ".", $PostData['user_comissao']);
            endif;
            ...
            if ($PostData['user_level'] == 3) :
                $jSON['redirect'] = "dashboard.php?wc=configuracoes/ven_home";
            endif;
            if ($PostData['user_level'] == 4) :
                $jSON['redirect'] = "dashboard.php?wc=configuracoes/col_home";
            endif;
            if ($PostData['user_level'] == 5) :
                $jSON['redirect'] = "dashboard.php?wc=configuracoes/for_home";
            endif;
        ...
        case 'delete':
            ...
            if (!$Read->getResult()) :
                ...
                elseif ($user_level > $_SESSION['userLogin']['user_level']) :
                    ...
                    $level = $_SESSION['userLogin']['user_id'];
