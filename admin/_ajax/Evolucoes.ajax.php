...
if ($PostData && $PostData['callback_action'] && $PostData['callback'] == $CallBack) :
    ...
    switch ($Case):
        ...
        case 'manager':
            ...
            $jSON['trigger'] = AjaxErro("<b class='icon-checkmark'>TUDO CERTO:</b> Olá {$_SESSION['userLogin']['user_name']}. A Evolução foi atualizado com sucesso!");
            $jSON['redirect'] = "dashboard.php?wc=evolucoes/home&user={$Read->getResult()[0]['change_user_id']}";
            break;
        ...
        case 'delete':
            ...
            if (!$Read->getResult()) :
                $jSON['trigger'] = AjaxErro("<b class='icon-warning'>ANÁLISE NÃO EXISTE:</b> Olá {$_SESSION['userLogin']['user_name']}, você tentou deletar uma Evolução que não existe ou já foi removido!", E_USER_WARNING);
            else :
