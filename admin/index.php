...
<html lang="en">
    ...
    <head>
        ...
        <link href="_assets/css/pages/login/login-2.css" rel="stylesheet" type="text/css" />
    ...
    <body id="kt_body" class="header-fixed subheader-enabled page-loading">
            ...
            <div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
                <div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
                    <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                        <a href="#" class="text-center pt-2">
                            <img src="_img/logo.png" class="max-h-75px" alt="" />
                        </a>
                            ...
                            <div class="login-form login-signin py-11">
                                <form class="login_form" name="work_login" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="email" name="user_email" autocomplete="off" value="<?= $Cookie ? $Cookie : ''; ?>" />
                                    </div>
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between mt-n5">
                                            <label class="font-size-h6 font-weight-bolder text-dark pt-5">Senha</label>
                                            <?php /* <a href="javascript:;" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5" id="kt_login_forgot">Forgot Password ?</a> */ ?>
                                        </div>
                                        <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="password" name="user_password" autocomplete="off" />
                                    </div>
                                    <div class="text-center pt-2">
                                        <button class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">Acessar</button>
                ...
                <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
                    <div class="d-flex flex-column justify-content-center text-center pt-lg-40 pt-md-5 pt-sm-5 px-lg-0 pt-5 px-7">
                        <h3 class="display4 font-weight-bolder my-7 text-dark" style="color: #986923;">A plataforma de análise facial</h3>
                        <p class="font-weight-bolder font-size-h2-md font-size-lg text-dark opacity-70">Solução ideal para profissionais de saúde que precisam tirar e gerenciar uma grande quantidade de fotos dos seus pacientes, de forma segura, prática e inteligente.</p>
                    </div>
                    <div class="content-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url(_assets/media/svg/illustrations/login-visual-2.svg);"></div>
                </div>
            </div>
        </div>
        ...
        <script src="_assets/js/pages/custom/login/login-general.js"></script>
        <!--end::Page Scripts-->
