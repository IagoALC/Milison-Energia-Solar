                ...
                <div class="slide-content row">
                    <div class="col-12 d-flex justify-content-start justify-content-md-center inner">
                        <div class="center text-left text-md-center">
                            ...
                            <!-- Content -->
                            <h1 data-aos="zoom-in" data-aos-delay="2000" class="title effect-static-text">MILI<span class="featured">SOL</span></h1>
                            <p data-aos="zoom-in" data-aos-delay="2400" class="description mr-auto ml-auto">Estratégias de sucesso precisam de análise, criatividade e um trabalho personalizado, com a ajuda das últimas tecnologias para entregar o melhor trabalho.</p>
                            ...
                            <div data-aos="fade-up" data-aos-delay="2800" class="buttons">
                                <div class="d-sm-inline-flex">
                                    ...
                                    <a href="<?= BASE ?>/#process" class="smooth-anchor ml-sm-4 mt-4 btn outline-button">Saiba Mais</a>
                                </div>
                            </div>
                        </div>
                    </div>
