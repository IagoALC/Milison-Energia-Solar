...
if (!$WorkControlDefineConf):
    ...
    if($_SERVER['HTTP_HOST'] == 'localhost'):
        define('BASE', 'https://localhost/harmoniser'); //Url raiz do site no localhost
    else:
...
if (!$WorkControlDefineConf):
     ...
     * ADMIN CONFIG
     */
    define('ADMIN_NAME', 'Painel Pro');  //Nome do painel de controle (Work Control)
    define('ADMIN_DESC', 'O Painel Pro é um sistema de gestão de conteúdo profissional gerido pela Mx Soluções Empresariais!'); //Descrição do painel de controle (Work Control)
